...
export const GetNewsList = (skip = 0, take = 10, isFilterEffective, isEnable) => {//取得最新消息清單
    return request('get', `/NewsSetting/GetNewsList`, { isFilterEffective, skip, take, isEnable })
}
