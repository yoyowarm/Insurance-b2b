...
export default {
  ...
  state: {
    uuid: '',
    InsuranceActive: 0,//0:新增、複製,1:更改,2:更改要被保人,3:新增方案,4:續保,5:報價明細,6:查看取消序號報價單,7:審核,8:查看核保中報價單,9:核保歷程查看報價單
  ...
  actions: {
    ...
    updatedPolicyStatus({ commit }, type) {
      commit('UPDATED_POLICY_STATUS', type)
    },
