...
export default {
  ...
  computed: {
    ...
    paginationPage() {
      return ['/termsSetting/quotationAndWeight','/parameterSetting/news-setting','/parameterSetting/document-download-setting','/parameterSetting/news-setting','/questionnaire-management','/quotation/list', '/product/list', '/news/list', '/quotation-ist', '/underwriting-list'].includes(this.$route.path)
    },
    innerWidth() {
