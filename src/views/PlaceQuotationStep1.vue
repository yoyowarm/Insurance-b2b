  ...
  <div>
    <CommonBoard class="w-full" title="訂單續保">
      ...
      <div class="column-5">
        ...
        <InputGroup class="w-ful" disabled>
        <div slot="input" class="w-full pr-24 relative">
          <Input placeholder="輸入保單號碼" :value="renewal.InsuranceNumber" @updateValue="(e) => $store.dispatch('place/updatedRenewal', Object.assign(renewal, {InsuranceNumber: e}))" disabled/>
