  ...
  <div>
    ...
    <div class="flex flex-row justify-center items-center w-full mt-8">
      ...
      <template v-if="InsuranceActive == 7">
        <Button v-if="(underwriteStatus.underwriteLevel <= underwriteStatus.underwriteTargetLevel && underwriteStatus.employeeUnderwriteLevel != 6) || underwriteStatus.isLastActionEditUnderwrite" class="my-8 w-40 md:w-64 mr-5" @click.native="updateUnderwrite(1)">向上核保</Button>
