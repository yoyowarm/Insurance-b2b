  ...
  <div>
    ...
    <div class="flex flex-col justify-center items-center w-full mt-8">
      ...
      <div class="flex flex-col sm:flex-row">
        ...
        <Button @click.native="openQuestionnaire = true" class="my-2 sm:my-6 w-56 md:w-42" outline>填寫問卷表({{insuranceAmountListData.parameter.underwriteCoefficient ? Number(insuranceAmountListData.parameter.underwriteCoefficient)*100 : '0'}}%)</Button>
      </div>
