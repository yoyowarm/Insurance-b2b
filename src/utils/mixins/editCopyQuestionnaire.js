...
export default {
  ...
  methods: {
    ...
    placeQuestionnaireMapping(data) {
      ...
      if (this.questionnaire.part1.createTime && Object.keys(this.questionnaire.part1.createTime).every(key => this.questionnaire.part1.createTime[key] !== '' && !isNaN(this.questionnaire.part1.createTime[key]))) {
      ...
      if (this.questionnaire.part1.businessStartDate && Object.keys(this.questionnaire.part1.businessStartDate).every(key => this.questionnaire.part1.businessStartDate[key] && !isNaN(this.questionnaire.part1.businessStartDate[key]))) {
      ...
      if (this.questionnaire.part1.businessEndDate && Object.keys(this.questionnaire.part1.businessEndDate).every(key => this.questionnaire.part1.businessEndDate[key] && !isNaN(this.questionnaire.part1.businessEndDate[key]))) {
    ...
    activityQuestionnaireMapping(data) {
      data.questionnaire = data.questionnaire ? data.questionnaire : JSON.parse(JSON.stringify(this.questionnaire))
      if (data.questionnaire.sheet1.part1.beginDateTime && Object.keys(data.questionnaire.sheet1.part1.beginDateTime).every(key => data.questionnaire.sheet1.part1.beginDateTime[key] !== '' && !isNaN(data.questionnaire.sheet1.part1.beginDateTime[key]))) {
