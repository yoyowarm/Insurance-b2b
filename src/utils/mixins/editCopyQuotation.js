    ...
    step2InitAssignValue(type) {
      ...
      if (Object.keys(this.quotationData.insuraned).length > 0) {
        Object.assign(Insuraned, {
          ...
          prefixNumber: this.quotationData.insuraned.mobile ? (/^09/.test(this.quotationData.insuraned.mobile) ? this.quotationData.insuraned.mobile.toString().slice(0, 4,) : this.quotationData.insuraned.mobile.toString().slice(0, 2)) : '',
          Mobile: this.quotationData.insuraned.mobile ? (/^09/.test(this.quotationData.insuraned.mobile) ? this.quotationData.insuraned.mobile.toString().slice(4,) : this.quotationData.insuraned.mobile.toString().slice(2,)) : '',
